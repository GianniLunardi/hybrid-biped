...
class BipedParams:
    ...
    def __init__(self):
        ...
        self.step_width = 0.192
        self.step_height = 0.05

        # ICs
        self.foot_step_0 = np.array([0., -self.step_width/2])
        self.tau_hat_0 = data['x0'][-1].item()
        self.x_hat_0 = data['x0'][:-1].T[0]
        self.y_hat_0 = np.array([-0.09, 0.1])
        self.ref_0 = data['ref0'].T[0]

        # Feet trial coordinates
        self.x_LF_trial = np.array([0., self.step_width/2, 0.07])
        self.x_RF_trial = np.array([-0.0, -self.step_width/2, 0.12])
        ...
        self.path = '/home/glunardi/devel/src/temp/tsid/models/romeo'
        self.urdf = self.path + '/urdf/romeo.urdf'
        self.srdf = self.path + '/srdf/romeo_collision.srdf'
        ...
        self.torso_frame_name = "torso"  # torso frame name
        self.contactNormal = np.array([0., 0., 1.])  # direction of the normal to the contact surface
        ...
        self.w_am = 0#1e-4  # weight of angular momentum task
        self.w_torso = 1e-2  # weight of torso orientation task
        ...
        self.kp_torso = 10.0  # proportional gain of torso orientation task
        ...
        self.mask_torso = np.array([0, 0, 0, 1, 1, 1])
